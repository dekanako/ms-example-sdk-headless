...
import com.theminesec.example.headless.databinding.CompOrSignatureScreenBinding
import com.theminesec.example.headless.databinding.CompOrUiStateDisplayBinding
import com.theminesec.example.headless.landing.HLTAG
...
class HeadlessImplXml : HeadlessActivity() {
...
class ClientViewProvider :
    ...
    override fun onCountdownUpdate(countdownSec: Int) {
        Log.d(HLTAG, "xml onCountdownUpdate: $countdownSec")
